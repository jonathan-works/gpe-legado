...
/*
sqlserver
o.type_desc, SCHEMA_NAME(t.schema_id), t.name, o.name, m.constraint_name_depois
*/
SELECT concat('sp_rename ''', SCHEMA_NAME(o.schema_id), '.', o.name, ''', ''' , m.constraint_name_depois, ''';')
FROM sys.objects o
left join sys.tables t on (o.parent_object_id = t.object_id)
inner join tmp_migracao_constraint m on (t.name = m.table_name and o.name = m.constraint_name_antes)
WHERE
o.type IN ('C','F', 'PK');
...
duplicados
*/
ALTER TABLE tb_caixa DROP tb_caixa_nm_caixa_id_tarefa_key1;
ALTER TABLE tb_caixa DROP tb_caixa_nm_caixa_id_tarefa_key2;
ALTER TABLE tb_caixa DROP tb_caixa_id_tarefa_id_node_anterior_key1;
ALTER TABLE tb_caixa DROP tb_caixa_id_tarefa_id_node_anterior_key2;
ALTER TABLE tb_caixa DROP CONSTRAINT idx_tb_caixa1;
ALTER TABLE tb_participante_processo DROP idx_tb_part_processo_id_pessoa;
...
finalizando
*/
drop table tmp_migracao_constraint;
