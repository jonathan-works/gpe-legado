...
@XmlRootElement(name = "WSControleAcessoGPE.GETMENUSISTEMASResponse")
public class WSControleAcessoGPEGETMENUSISTEMASResponse {

    @XmlElement(name = "Html", required = true)
    protected String html;

    /**
     * Obt�m o valor da propriedade html.
     * 
     * @return
     *     possible object is
     *     {@link String }
